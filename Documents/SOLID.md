...
| `App.tsx` | Composes root providers only (gesture handler, safe area, navigation) |
...
| `src/navigation/AppNavigator.tsx` | `RootStackParamList` defines only the params each screen needs — screens don't share a single bloated params type |
